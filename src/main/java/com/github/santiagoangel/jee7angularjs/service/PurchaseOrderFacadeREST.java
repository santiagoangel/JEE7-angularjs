...
import com.github.santiagoangel.jee7angularjs.PurchaseOrder;
 ...
 */
@Stateless
@Path("com.github.santiagoangel.jee7angularjs.purchaseorder")
public class PurchaseOrderFacadeREST extends AbstractFacade<PurchaseOrder> {
    @PersistenceContext(unitName = "com.github.santiagoangel_jee7angularjs_war_1.0-SNAPSHOTPU")
